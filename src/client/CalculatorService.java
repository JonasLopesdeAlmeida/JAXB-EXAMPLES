 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9999/calculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://service/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/calculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://service/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "CalculatorPort"), Calculator.class, features);
    }
